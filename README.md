...
- **Análisis temporal:**
  - Número de partidas jugadas diariamente para identificar tendencias en la actividad de los jugadores.
  - Frecuencia de partidas por día de la semana (de Lunes a Domingo) para explorar patrones de comportamiento semanal.
